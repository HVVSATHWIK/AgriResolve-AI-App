...
export const Diagnosis: React.FC = () => {
    ...
    // Determine Mode: 'diagnosis' (default) or 'bioprospector'
    const mode = React.useMemo(() => {
        const params = new URLSearchParams(window.location.search);
        return params.get('mode') === 'bioprospector' ? 'bioprospector' : 'diagnosis';
    }, []);
                    ...
                    <div className="max-w-4xl mx-auto mt-8">
                        ...
                        >
                            ...
                            <p className="text-gray-600 font-medium">
                                {isBioProspector ? t('bio_welcome_desc', 'Identify weeds, medicinal plants, and potential bio-fertilizers.') : t('subtitle')}
                            </p>
                        </motion.div>
                        ...
                        {!image && !data && (
                            ...
                            >
                                ...
                                <h2 className="text-3xl font-bold text-gray-900 mb-4 drop-shadow-sm">
                                    {isBioProspector ? t('bio_upload_title', 'Upload Plant Photo') : t('upload_title')}
                                </h2>
                                <p className="text-gray-700 mb-8 max-w-md mx-auto text-lg font-medium">
                                    {isBioProspector ? t('bio_upload_desc', 'Take a clear photo of the plant or weed you want to identify.') : t('upload_desc')}
